...
| OS | Snippet |
|:---|:---|
| `macOS` | `bash -c "$(curl -LsS https://raw.github.com/srihas/alrra-dotfiles/main/src/os/setup.sh)"` |
| `Ubuntu` | `bash -c "$(wget -qO - https://raw.github.com/srihas/alrra-dotfiles/main/src/os/setup.sh)"` |
